...
(use-package gnus
  ...
  (progn
    ...
    (setq gnus-always-read-dribble-file t) ;; Skip prompt: "Gnus auto-save file exists. Do you want to read it?"
    (setq gnus-gcc-mark-as-read t) ;; Mark sent messages as read
    (setq gnus-inhibit-startup-message t)
    (setq gnus-use-full-window nil) ;; Do not take over the entire frame

    ;; (setq nnimap-record-commands t) ;; Record all IMAP commands in the ‘"*imap log*"’
    )
#+end_src
