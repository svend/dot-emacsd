...
(defun my-load-theme ()
  ...
  (load-theme 'svend t)
  (load-theme 'svend-font-source-pro t))
#+end_src
...
(use-package ivy
  ...
  :bind (("C-c s" . swiper))
  :config
  ;; FIXME: not working https://github.com/abo-abo/swiper/issues/2144
  (setq ivy-re-builders-alist '((amx . ivy--regex-fuzzy)
                                (t . ivy--regex-plus))
        ivy-magic-tilde nil
...
(use-package racer
  :config
  ;; Use default src path detection
