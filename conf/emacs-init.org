...
Remove Nix system site-lisp from load path, since this contains an old version
of nix-mode. https://github.com/NixOS/nix/pull/1529

#+begin_src emacs-lisp
(delete "/run/current-system/sw/share/emacs/site-lisp/" load-path)
#+end_src
