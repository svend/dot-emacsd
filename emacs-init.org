...
(global-set-key
 (kbd "C-c t")
 (defhydra hydra-toggle (:timeout 2)
   "Winner"
   ...
   ("t" toggle-runcate-lines "trucate")
   ("v" my-fixed-pitch-mode "fixed-pitch")
   ("w" whitespace-mode "fixed-pitch")))
...
(use-package pdf-tools
  ...
  :config (add-to-list 'pdf-tools-enabled-modes 'pdf-view-auto-slice-minor-mode))
#+end_src
