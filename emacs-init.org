...
#+begin_src sh
HOMEBREW_KEEP_INFO=1 brew install emacs --cocoa --with-gnutls --with-imagemagick --with-librsvg
...
(use-package exec-path-from-shell
  ...
  (progn
    (mapc
     ...
     '("ALTERNATE_EDITOR" "EDITOR" "GOPATH" "GPG_AGENT_INFO" "HISTFILE" "INFOPATH" "LANG" "LC_ALL" "SSH_AUTH_SOCK"))
