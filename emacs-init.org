...
Install from homebrew on OS X. =brew linkapps emacs= creates a symlink
under =/Applications=, but Emacs does not show up in Spotlight. Emacs
does show up in Spotlight if a symlink is created under
=~/Applications=.
